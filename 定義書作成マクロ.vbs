...
Function GetSheet1Values(ws)
    ...
    arr(0) = Nz(ws.Range("AI4").Value2)
    arr(1) = Nz(ws.Range("AH4").Value2)
    arr(2) = Nz(ws.Range("AG4").Value2)
    arr(3) = Nz(ws.Range("AV4").Value2)
    arr(4) = ConvertPrefixName(Nz(ws.Range("C4").Value2))
    arr(5) = ConvertPrefixName(Nz(ws.Range("D4").Value2))
    arr(6) = Nz(ws.Range("DU4").Value2)
    arr(7) = Nz(ws.Range("H4").Value2)
    arr(8) = Nz(ws.Range("AZ4").Value2)
    arr(9) = Nz(ws.Range("AK4").Value2)
    arr(10) = ConvertPrefixName(Nz(ws.Range("DK4").Value2))
    arr(11) = ConvertPrefixName(Nz(ws.Range("DM4").Value2))
    arr(12) = Nz(ws.Range("BP4").Value2)
    arr(13) = Nz(ws.Range("Z4").Value2)
    arr(14) = Nz(ws.Range("AM4").Value2)
    arr(15) = Nz(ws.Range("AL4").Value2)
    arr(16) = Nz(ws.Range("BF4").Value2)
    arr(17) = Nz(ws.Range("CG4").Value2)
    arr(18) = Nz(ws.Range("CK4").Value2)
    arr(19) = Nz(ws.Range("AR4").Value2)
    arr(20) = Nz(ws.Range("BY4").Value2)
    arr(21) = Nz(ws.Range("BN4").Value2)
    arr(22) = Nz(ws.Range("BK4").Value2)
    arr(23) = Nz(ws.Range("AT4").Value2)
    arr(24) = Nz(ws.Range("K4").Value2)
    arr(25) = Nz(ws.Range("AU4").Value2)
    arr(26) = Nz(ws.Range("DS4").Value2)
    arr(27) = Nz(ws.Range("CC4").Value2)
    arr(28) = Nz(ws.Range("CR4").Value2)
